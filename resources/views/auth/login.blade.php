...
@section('content')
<!-- component -->
<div class="h-full bg-gradient-to-tl from-slate-50 to-slate-100 w-full py-16 px-4">
            <div class="flex flex-col items-center justify-center">
                <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    <p tabindex="0" class="focus:outline-none text-2xl font-semibold leading-6 text-gray-800">Login to your account</p>
                    ...
                    <a href="{{ route('auth.google') }}"  class="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        <div>
                            ...
                            <input aria-labelledby="email" type="email" name="email" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2 @error('email') border-rose-400 @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus/>
                            @error('email')
                        ...
                        <div class="relative flex items-center justify-center">
                            <input id="password" type="password" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2 @error('password') border-rose-400 @enderror" name="password" required autocomplete="current-password"/>
                        ...
                        <div class="mt-8">
                            <button type="submit" role="button" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">{{ __('Login') }}</button>
